...
export interface Iidev10TabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface Iidev10TabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of idev10 Tab remove page
 */
export class idev10TabRemove  extends TeamsBaseComponent<Iidev10TabRemoveProps, Iidev10TabRemoveState> {
